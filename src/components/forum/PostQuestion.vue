                ...
                <div class="card p-3">
                    ...
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="contents" v-model="contents" :rows=20 class="form-control"></textarea>
                            <p>Category</p>
                            <select class="form-select" v-model="selectedFilter">
                                <option v-for="filter in filterByOptions" :key="filter.id" :value="filter">
                                    {{ filter.name }}
                                </option>
                            </select>
                        </div>
                        <button type="button" @click="createPost(selectedFilter.id)"
